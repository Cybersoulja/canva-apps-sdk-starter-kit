import { Button, Rows, Text, OpenInNewIcon } from "@canva/app-ui-kit";
  ...
  return (
    <div className={styles.scrollContainer}>
      <Rows spacing="2u">
        ...
        <Button variant="secondary" onClick={() => openExternalUrl(DOCS_URL)} icon={OpenInNewIcon} iconPosition="end">
          {intl.formatMessage({
